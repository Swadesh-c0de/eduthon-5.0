...
const Legacy = () => {
    ...
    return (
                        ...
                        >
                            ...
                            <div className="edition-card">
                                <div className="edition-image-container">
                                    <img src={edition.image} alt={`EDUTHON ${edition.id}.0`} />
        ...
        .timeline-container {
          position: relative;
          padding: ${isMobile ? '2rem 0 2rem 20px' : '4rem 0'};
        ...
        .timeline-entry {
          position: relative;
          margin-bottom: ${isMobile ? '5rem' : '7rem'};
          display: flex;
        ...
        .badge-container {
          display: flex;
          ${isMobile ? 'flex-direction: column; align-items: center;' : 'flex-direction: row; justify-content: space-between; align-items: center; padding: 0.5rem 1.5rem;'}
        ...
        .edition-badge {
          ...
          margin: ${isMobile ? '0.5rem auto 1rem auto' : '0'};
          ${!isMobile ? 'order: 2;' : ''}
        }
        ...
        .image-date-badge {
          ...
          display: block;
          width: fit-content;
          margin: ${isMobile ? '0.75rem auto 0.5rem auto' : '0'};
        ...
        /* Comprehensive Image Stabilization for Desktop */
        .edition-image-container img {
          width: 100%;
          height: 100%;
          object-fit: cover;
        ...
        /* Target all potential active/hover states that might be causing zoom */
        ...
        /* Make the image container itself stable */
        .edition-image-container {
          overflow: hidden;
